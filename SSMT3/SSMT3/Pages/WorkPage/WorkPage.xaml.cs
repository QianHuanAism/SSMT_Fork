...
namespace SSMT3
{
    ...
    public sealed partial class WorkPage : Page
    {
        ...
        private void OnMyCustomPageLoaded(object sender, RoutedEventArgs e)
        {
            ...
            IsLoading = true;
            ToggleSwitch_DumpIBListConfig.IsOn = GlobalConfig.UseSpecificIBListDump;
            IsLoading = false;
        }
        ...
        private void InitializeGameTypeComboBox()
        {
            ...
            string[] FilePathList = Directory.GetFiles(PathManager.Path_CurrentSelected_GameTypeFolder);
        ...
        private async void Menu_ExtractRenderTextures_Click(object sender, RoutedEventArgs e)
        {
            SaveDrawIBList();
            await CoreFunctions.ExtractRenderTextures();
            SSMTCommandHelper.ShellOpenFolder(PathManager.Path_CurrentWorkSpaceFolder);
        }
        ...
        private void Button_AutoDetectGameTypeDrawIBList_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (string DrawIB in TotalDrawIBList)
                {
                    ...
                    List<D3D11GameType> d3D11GameTypeList = ZZMI.GetPossibleGameTypeList_UnityVS(DrawIB, PointlistIndex, TrianglelistIndexList, d3D11GameTypeLv2);
        ...
        private void SetD3dxConfig_DumpSpecificIBListConfig()
        {
            ...
            foreach (DrawIBItem item in DrawIBItems)
            {
                if (item.DrawIB.Trim() != "")
                {
                    ...
                    if (item.DrawIB.Trim() != "")
                    {
                        ...
                        DumpIBListConfigIniList.Add("analyse_options = " + analyse_options);
            ...
            foreach (string RootShader in RootShaderList)
            {
                ...
                DumpIBListConfigIniList.Add("analyse_options = " + PathManager.analyse_options);
                DumpIBListConfigIniList.Add("");
            }
        ...
        private void SetD3dxConfig_RecoverGlobalDumpConfig()
        {
            ...
            D3dxIniConfig.SaveAttributeToD3DXIni(PathManager.Path_D3DXINI, "[hunting]", "analyse_options", PathManager.analyse_options);
        }
        ...
        private void ToggleSwitch_DumpIBListConfig_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            //先保存到全局配置中
            GlobalConfig.UseSpecificIBListDump = ToggleSwitch_DumpIBListConfig.IsOn;
            GlobalConfig.SaveConfig();
        ...
        private async void ButtonOpenWorkSpaceGeneratedModFolder_Click(object sender, RoutedEventArgs e)
        {
